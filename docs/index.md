...
- [hcxdumptool](https://search.nixos.org/packages?channel=unstable&show=hcxdumptool&type=packages&query=hcxdumptool)
- [hcxtools](https://search.nixos.org/packages?channel=unstable&show=hcxtools&type=packages&query=hcxtools)
...
- [wepwolf](https://search.nixos.org/packages?channel=unstable&show=wepwolf&type=packages&query=wepwolf)
- [wifite2](https://search.nixos.org/packages?channel=unstable&show=wifite2&type=packages&query=wifite2)
- [wpawolf](https://search.nixos.org/packages?channel=unstable&show=wpawolf&type=packages&query=wpawolf)
...
- [mithril](https://search.nixos.org/packages?channel=unstable&show=mithril&type=packages&query=mithril)
- [moria](https://search.nixos.org/packages?channel=unstable&show=moria&type=packages&query=moria)
...
- [flawz](https://search.nixos.org/packages?channel=unstable&show=flawz&type=packages&query=flawz)
...
- [nali](https://search.nixos.org/packages?channel=unstable&show=nali&type=packages&query=nali)
...
- [credwolf](https://search.nixos.org/packages?channel=unstable&show=credwolf&type=packages&query=credwolf)
...
- [errcheck](https://search.nixos.org/packages?channel=unstable&show=errcheck&type=packages&query=errcheck)
...
- [python3Packages.safety](https://search.nixos.org/packages?channel=unstable&show=python3Packages.safety&type=packages&query=python3Packages.safety)
...
- [atac](https://search.nixos.org/packages?channel=unstable&show=atac&type=packages&query=atac)
...
- [h2spec](https://search.nixos.org/packages?channel=unstable&show=h2spec&type=packages&query=h2spec)
...
- [introspectre](https://search.nixos.org/packages?channel=unstable&show=introspectre&type=packages&query=introspectre)
...
- [kube-hunter](https://search.nixos.org/packages?channel=unstable&show=kube-hunter&type=packages&query=kube-hunter)
...
- [mobsf](https://search.nixos.org/packages?channel=unstable&show=mobsf&type=packages&query=mobsf)
- [morf](https://search.nixos.org/packages?channel=unstable&show=morf&type=packages&query=morf)
- [otadump](https://search.nixos.org/packages?channel=unstable&show=otadump&type=packages&query=otadump)
...
- [peirates](https://search.nixos.org/packages?channel=unstable&show=peirates&type=packages&query=peirates)
...
- [xnldorker](https://search.nixos.org/packages?channel=unstable&show=xnldorker&type=packages&query=xnldorker)
...
- [nfswolf](https://search.nixos.org/packages?channel=unstable&show=nfswolf&type=packages&query=nfswolf)
...
- [nerva](https://search.nixos.org/packages?channel=unstable&show=nerva&type=packages&query=nerva)
...
- [stave](https://search.nixos.org/packages?channel=unstable&show=stave&type=packages&query=stave)
...
- [sqlmc](https://search.nixos.org/packages?channel=unstable&show=sqlmc&type=packages&query=sqlmc)
...
- [snmpen](https://search.nixos.org/packages?channel=unstable&show=snmpen&type=packages&query=snmpen)
...
- [tlsanalyser](https://search.nixos.org/packages?channel=unstable&show=tlsanalyser&type=packages&query=tlsanalyser)
- [cryptoscan](https://search.nixos.org/packages?channel=unstable&show=cryptoscan&type=packages&query=cryptoscan)
- [mini-pqc](https://search.nixos.org/packages?channel=unstable&show=mini-pqc&type=packages&query=mini-pqc)
- [pqc-bench](https://search.nixos.org/packages?channel=unstable&show=pqc-bench&type=packages&query=pqc-bench)
...
- [spearspray](https://search.nixos.org/packages?channel=unstable&show=spearspray&type=packages&query=spearspray)
...
- [copacetic](https://search.nixos.org/packages?channel=unstable&show=copacetic&type=packages&query=copacetic)
...
- [lse](https://search.nixos.org/packages?channel=unstable&show=lse&type=packages&query=lse)
...
- [puredns](https://search.nixos.org/packages?channel=unstable&show=puredns&type=packages&query=puredns)
...
- [tldfinder](https://search.nixos.org/packages?channel=unstable&show=tldfinder&type=packages&query=tldfinder)
...
- [kerbwolf](https://search.nixos.org/packages?channel=unstable&show=kerbwolf&type=packages&query=kerbwolf)
...
- [ntdswolf](https://search.nixos.org/packages?channel=unstable&show=ntdswolf&type=packages&query=ntdswolf)
...
- [skewrun](https://search.nixos.org/packages?channel=unstable&show=skewrun&type=packages&query=skewrun)
...
- [tcping-rs](https://search.nixos.org/packages?channel=unstable&show=tcping-rs&type=packages&query=tcping-rs)
- [tcptraceroute](https://search.nixos.org/packages?channel=unstable&show=tcptraceroute&type=packages&query=tcptraceroute)
...
- [hacksguard](https://search.nixos.org/packages?channel=unstable&show=hacksguard&type=packages&query=hacksguard)
...
- [yara-x](https://search.nixos.org/packages?channel=unstable&show=yara-x&type=packages&query=yara-x)
